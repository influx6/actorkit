...
// and equal.
//
//    require.EqualValuesf(t, uint32(123, "error message %s", "formatted"), int32(123))
...
//
//    require.Exactlyf(t, int32(123, "error message %s", "formatted"), int64(123))
...
//
//    require.Implementsf(t, (*MyInterface, "error message %s", "formatted")(nil), new(MyObject))
...
//
// 	 require.InDeltaf(t, math.Pi, (22 / 7.0, "error message %s", "formatted"), 0.01)
...
//
//  require.NotRegexpf(t, regexp.MustCompile("starts", "error message %s", "formatted"), "it's starting")
...
//
//    require.NotSubsetf(t, [1, 3, 4], [1, 2], "But [1, 3, 4] does not contain [1, 2]", "error message %s", "formatted")
...
//
//  require.Regexpf(t, regexp.MustCompile("start", "error message %s", "formatted"), "it's starting")
...
// elements given in the specified subset(array, slice...).
//
//    require.Subsetf(t, [1, 2, 3], [1, 2], "But [1, 2, 3] does contain [1, 2]", "error message %s", "formatted")
