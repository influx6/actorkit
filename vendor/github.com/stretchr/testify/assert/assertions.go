...
//
//    require.Subset(t, [1, 2, 3], [1, 2], "But [1, 2, 3] does contain [1, 2]")
...
// elements given in the specified subset(array, slice...).
//
//    require.NotSubset(t, [1, 3, 4], [1, 2], "But [1, 3, 4] does not contain [1, 2]")
...
// PanicTestFunc defines a func that should be passed to the require.Panics and require.NotPanics
